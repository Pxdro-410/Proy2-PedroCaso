<template>
  <div class="page-container">
    <div class="header-actions" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
      <h1 class="page-title" style="margin-bottom: 0;">Gestión de Categorías</h1>
      <button class="btn-primary">+ Nueva Categoría</button>
    </div>
    ...
    <div class="glass-panel p-6">
      <div class="empty-state" style="text-align: center; padding: 3rem 0;">
        ...
        <p class="text-secondary">Aquí irá el CRUD de Categorías.</p>
      </div>
    </div>
  </div>
</template>
